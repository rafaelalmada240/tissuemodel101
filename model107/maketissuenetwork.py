...
for i in range(N):
    with open('tissue/size'+str(size_of_wound)+'/centers.txt','a') as text:
...
for v in range(len(vorVertex)):
    ...
    with open('tissue/size'+str(size_of_wound)+'/vertices.txt','a') as text:
        text.write(str(v)+";"+str(vorVertex[v,0])+";"+str(vorVertex[v,1])+";"+str(Neigh_C)+";"+str(Neigh_V)+"\n")
        
for e in range(len(vorRidges)):
    with open('tissue/size'+str(size_of_wound)+'/edges.txt','a') as text:
...
with open('tissue/size'+str(size_of_wound)+'/boundaries.txt','a') as text:
    text.write(str(boundary_tissue)+"\n")
    text.write(str(boundary_wound)+"\n")


with open('tissue/size'+str(size_of_wound)+'/woundloc.txt','a') as text:
